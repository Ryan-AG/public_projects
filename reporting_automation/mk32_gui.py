...
update_list1 = ['MK32 Template... loaded.', 'CSM Workbook... loaded.',
                'MK30 Workbook... loaded.', 'Maxim Workbook... loaded.']

update_list2 = ['MK32: CSM Worksheet... complete.',
                'MK32: MK30 Worksheet... complete.', 'MK32: Maxim Worksheet... complete.']
...
def update_listbox(list_obj):
    complete_list.extend(list_obj)
    window['-LISTBOX-'].update(complete_list)
...
def main():
    ...
    while True:
        ...
        if event == "-START-":
            ...
            logger.debug('workbooks loaded...')

            update_listbox(update_list1)
            ...
            orig_wb_list = [csm_wb_worksheet,
                            mk30_wb_worksheet, maxim_wb_worksheet]
